...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${PODS_ROOT}/AnswerBotSDK/AnswerBotSDK/5.1/AnswerBotProvidersSDK.framework"
  install_framework "${PODS_ROOT}/AnswerBotSDK/AnswerBotSDK/5.1/AnswerBotSDK.framework"
