...
# Zendesk Answer Bot Providers SDK for iOS

Zendesk Answer Bot Providers SDK for mobile. The Answer Bot Providers SDK is a wrapper for the Anwer Bot API. Build own UI on top of the Zendesk's Machine learning ticket deflection bot.
...
By downloading or using the Zendesk Answer Bot Providers SDK, You agree to the Zendesk Master
Subscription Agreement https://www.zendesk.com/company/customers-partners/#master-subscription-agreement and Application Developer and API License
Agreement https://www.zendesk.com/company/customers-partners/#application-developer-api-license-agreement and
acknowledge that such terms govern Your use of and access to the Answer Bot Providers SDK.

If You make any Contributions (defined below) to the Zendesk Answer Bot Providers SDK, 
